...
- the stops_in_walk_dist.R function, which determines which of the stops within the GTFS dataset is inside or within walking distance of the areas_of_interest boundaries - CURRRENT IN DEVELOPMENT, NEXT STEP ISTO FIGURE OUT HOW TO MAKE SURE THAT THE PROJECTION USED IS IN METRES, OR TRANSFORM IF NECESSARY. 
