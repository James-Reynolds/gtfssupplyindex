...
(3) $Area_area$ is the area of the area of interest; and
...
<TO DO>
(3) create similar arrivals.R function
(4) finish drawing the ERD in lucid.app, 
and (5) then do all the other functions needed
