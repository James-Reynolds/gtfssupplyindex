...
si_by_area_and_hour_231010_wider %>% select(1, 6:28) %>% head(n=75) %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, first 75 SA1 zones, 4am to 2am only" )
...
```{r Melbourne_CBD_north_all_map_231006, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian rail and SA1 zones within the Melbourne CBD - North SA2 zone,SI values for January 16, 2024, by hour"}
...
map_si_by_area_and_hour_231010$hour_starting <- as_factor(map_si_by_area_and_hour_231010$hour_starting)

ggplot() + 
  geom_sf(data=map_si_by_area_and_hour_231010,
          aes(fill = SI)) +
            facet_wrap(vars(hour_starting)) +
  theme(axis.text.x=element_blank(), #remove x axis labels
        axis.ticks.x=element_blank(), #remove x axis ticks
...
```{r Clayton_campus_all_map_231006, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian rail and SA1 zones within the Melbourne CBD - North SA2 zone,SI values for January 16, 2024, by hour"}
...
```{r Caulfield_campus_all_map_231015, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian rail and SA1 zones within the Melbourne CBD - North SA2 zone,SI values for January 16, 2024, by hour"}

map_areas_of_interest_231010 <- load_areas_of_interest(absmapsdata::sa12021 %>% filter(sa2_name_2021 == "Caulfield - North") %>% select(sa1_code_2021),  area_id_field = "sa1_code_2021")

#Join SI to map data
map_si_by_area_and_hour_231010 <- inner_join(map_areas_of_interest_231010, si_by_area_and_hour_231010)
...
```{r Melbourne_CBD_north_all_map_231006, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian GTFS and SA1 zones within the Melbourne CBD - North SA2 zone,SI values for Saturday 14th October 2023, by hour"}
...
map_si_by_area_and_hour_231014$hour_starting <- as_factor(map_si_by_area_and_hour_231014$hour_starting)

ggplot() + 
  geom_sf(data=map_si_by_area_and_hour_231014,
          aes(fill = SI)) +
            facet_wrap(vars(hour_starting)) +
  theme(axis.text.x=element_blank(), #remove x axis labels
        axis.ticks.x=element_blank(), #remove x axis ticks
...
```{r Clayton_campus_all_map_231006, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian GTFS and SA1 zones within the Clayton (North) - Notting Hill SA2 zone, SI values for Saturday 14th October 2023, by hour"}
...
```{r Caulfield_campus_all_map_231015, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian GTFS and SA1 zones within the Caulfield - North SA2 zone, SI values for Saturday 14th October 2023, by hour"}

map_areas_of_interest_231014 <- load_areas_of_interest(absmapsdata::sa12021 %>% filter(sa2_name_2021 == "Caulfield - North") %>% select(sa1_code_2021),  area_id_field = "sa1_code_2021")

#Join SI to map data
map_si_by_area_and_hour_231014 <- inner_join(map_areas_of_interest_231014, si_by_area_and_hour_231014)
...
```{r Melbourne_CBD_north_all_map_231006, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian GTFS and SA1 zones within the Melbourne CBD - North SA2 zone,SI values for Sunday 15th October 2023, by hour"}
...
map_si_by_area_and_hour_231015$hour_starting <- as_factor(map_si_by_area_and_hour_231015$hour_starting)

ggplot() + 
  geom_sf(data=map_si_by_area_and_hour_231015,
          aes(fill = SI)) +
            facet_wrap(vars(hour_starting)) +
  theme(axis.text.x=element_blank(), #remove x axis labels
        axis.ticks.x=element_blank(), #remove x axis ticks
...
```{r Clayton_campus_all_map_231006, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian GTFS and SA1 zones within the MClayton (North) - Notting Hill SA2 zone,SI values for Sunday 15th October 2023, by hour""}
...
```{r Caulfield_campus_all_map_231015, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="Victorian GTFS and SA1 zones within the Caulfield - North SA2 zone, SI values for Sunday 15th October 2023, by hour"}

map_areas_of_interest_231015 <- load_areas_of_interest(absmapsdata::sa12021 %>% filter(sa2_name_2021 == "Caulfield - North") %>% select(sa1_code_2021),  area_id_field = "sa1_code_2021")

#Join SI to map data
map_si_by_area_and_hour_231015 <- inner_join(map_areas_of_interest_231015, si_by_area_and_hour_231015)
